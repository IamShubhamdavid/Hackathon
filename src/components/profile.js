...
const Profile = () => {
  ...
  const handleSaveProfile = () => {
    ...
    setIsEditing(false);
    // You would typically call an API here to update user data
  };
  ...
  const handleBlogSubmit = (e) => {
    e.preventDefault();
    // In a real app, this would submit the blog to the backend
    console.log('Submitting blog:', blogFormData);
          ...
          {activeTab === 'profile' && (
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ fontSize: '2rem', fontWeight: '700', color: '#27ae60', marginBottom: '5px' }}>0</p>
